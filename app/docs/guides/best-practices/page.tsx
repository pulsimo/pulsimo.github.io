...
export const metadata: Metadata = {
  title: 'Best Practices - Coming Soon - Pulsimo Documentation',
  description: 'Best practices for monitoring and managing services with Pulsimo',
}
    ...
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="max-w-2xl mx-auto text-center px-4">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
          Comprehensive best practices guide covering endpoint monitoring strategies, alert configuration, 
          incident response workflows, and performance optimization will be available here soon.
        </p>
          ...
          <div className="flex items-start gap-3 text-left">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Start with our{' '}
                <a href="/docs/architecture" className="text-cyan-600 dark:text-cyan-400 hover:underline font-medium">
                  Architecture Guide
                </a>{' '}
                and{' '}
                <a href="/docs/projects" className="text-cyan-600 dark:text-cyan-400 hover:underline font-medium">
